...
async function fetchLatest(target) {
  ...
  while (picked.length < target && page < 10) {
    ...
    const res = await fetch(`https://hn.algolia.com/api/v1/search_by_date?${qs}`, { headers: { 'User-Agent': 'ai-design-checker/0.1' } });
...
<div class="topbar"><b>AI Design Checker · hero font mix eval</b></div>
<div class="wrap">
