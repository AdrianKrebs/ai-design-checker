# Deploying the public AI Design Checker
...
fly launch --no-deploy --copy-config --name ai-design-checker --region iad
```
...
docker build -t ai-design-checker .
docker run -p 8080:8080 ai-design-checker
```
