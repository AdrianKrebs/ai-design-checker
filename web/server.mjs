// Production web server for the public AI Design Checker.
//
...
server.listen(PORT, () => console.log(`AI Design Checker listening on http://localhost:${PORT}/  (concurrency ${SCAN_CONCURRENCY})`));
